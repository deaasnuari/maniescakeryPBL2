        ...
        <ul class="py-2 text-sm text-gray-700" aria-labelledby="sortDropdownButton">
            <li>
                <a href="{{ request()->fullUrlWithQuery(['sort' => 'name_asc']) }}" 
                   class="block px-4 py-2 hover:bg-gray-100 {{ request('sort') === 'name_asc' ? 'bg-gray-100 font-semibold' : '' }}">
                   Name (A-Z)
                </a>
            </li>
            <li>
                <a href="{{ request()->fullUrlWithQuery(['sort' => 'name_desc']) }}" 
                   class="block px-4 py-2 hover:bg-gray-100 {{ request('sort') === 'name_desc' ? 'bg-gray-100 font-semibold' : '' }}">
                   Name (Z-A)
                </a>
            </li>
        </ul>
