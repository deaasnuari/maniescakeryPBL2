    ...
    <div class="flex w-full gap-5">
        ...
        <div class="flex flex-col">
            ...
            <div class="flex gap-4 flex-col w-80 mt-4">
                <a href="" class="flex items-center gap-5 bg-secondary py-2 px-4 text-white rounded-lg">
